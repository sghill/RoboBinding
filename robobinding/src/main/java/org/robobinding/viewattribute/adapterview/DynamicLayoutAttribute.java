...
class DynamicLayoutAttribute extends AbstractReadOnlyPropertyViewAttribute<AdapterView<?>, Integer>
{
	...
	private DataSetAdapterRowLayoutUpdater dataSetAdapterLayoutUpdater;
	
	public DynamicLayoutAttribute(AdapterView adapterView, DataSetAdapter<?> dataSetAdapter, DataSetAdapterRowLayoutUpdater dataSetAdapterLayoutUpdater)
	{
		setView(adapterView);
